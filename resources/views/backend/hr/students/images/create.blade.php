	...
	<div class="panel panel-widget forms-panel">
		<div class="forms">
			<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
				...
				<div class="col-md-12">
					<a href="{{route('student.images.index',$student)}}" class="btn btn-default"><i class="fas fa-arrow-circle-left green-btn"></i>Back</a>
				...
				<div class="form-body">
					<form action="{{route('student.images.store', $student)}}" method="POST" enctype="multipart/form-data">
					{{ csrf_field() }}					
